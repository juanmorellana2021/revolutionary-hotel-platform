...
try {
    ...
    $partnerData = [
        ...
        'owner_name' => filter_input(INPUT_POST, 'owner_name', FILTER_SANITIZE_FULL_SPECIAL_CHARS),
    ...
    $experienceData = [
        ...
        'difficulty_level' => filter_input(INPUT_POST, 'difficulty_level', FILTER_SANITIZE_FULL_SPECIAL_CHARS) ?: 'moderate',
        'category' => filter_input(INPUT_POST, 'category', FILTER_SANITIZE_FULL_SPECIAL_CHARS),
        'country' => $partnerData['country'],
        'city' => $partnerData['city'],
        'meeting_point' => filter_input(INPUT_POST, 'meeting_point', FILTER_SANITIZE_FULL_SPECIAL_CHARS),
