...
<body class="bg-gray-50">
    ...
    <header class="gradient-bg shadow-lg fixed top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <!-- Logo -->
                <a href="coming-soon.html" class="text-white text-2xl font-bold flex items-center">
                ...
                <nav class="hidden md:flex space-x-6">
                    <a href="public_booking.php" class="text-white hover:text-yellow-300 transition">
                        <i class="fas fa-hotel mr-1"></i> Hoteles
                    </a>
                    <a href="experiences_list.php" class="text-yellow-300 font-semibold">
                        <i class="fas fa-mountain mr-1"></i> Experiencias
                    </a>
                    <a href="travel_social.php" class="text-white hover:text-yellow-300 transition">
                        <i class="fas fa-users mr-1"></i> Social
                    </a>
                    <a href="wallet.php" class="text-white hover:text-yellow-300 transition">
                        <i class="fas fa-wallet mr-1"></i> Wallet
                    </a>
                    <?php if ($isLoggedIn): ?>
                        <a href="profile.php" class="text-white hover:text-yellow-300 transition">
                            <i class="fas fa-user mr-1"></i> Perfil
                        </a>
                        <a href="logout.php" class="text-white hover:text-yellow-300 transition">
                            <i class="fas fa-sign-out-alt mr-1"></i> Salir
                        </a>
                    <?php else: ?>
                        <a href="login.php" class="text-white hover:text-yellow-300 transition">
                ...
                <!-- CTA Button -->
                <a href="experience_register.php" class="bg-yellow-400 text-gray-900 px-4 py-2 rounded-lg font-semibold hover:bg-yellow-300 transition">
                    <i class="fas fa-plus mr-1"></i> Registrar Experiencia
                </a>
            </div>
        </div>
    </header>
