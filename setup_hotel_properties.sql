-- Create hotel_properties table for listing multiple hotel properties
-- This is different from the 'hotels' table which stores hotel info/config
...
-- Insert testing data (6 hotel properties)
INSERT INTO `hotel_properties` (`name`, `location`, `emoji`, `rating`, `price`, `features`, `aini_coins`, `category`, `latitude`, `longitude`, `images`, `description`) VALUES
...
SELECT id, name, location, price, rating FROM hotel_properties;
