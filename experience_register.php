            ...
            <div class="form-step" data-step="4">
                ...
                <div class="mb-3">
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> 
                        Haz click en el mapa para marcar la ubicación exacta de tu experiencia. 
                    ...
                    <small class="text-muted" id="coords-display">
                        Coordenadas: <span id="coords-text">No seleccionadas</span>
                    </small>
                </div>
            </div>
