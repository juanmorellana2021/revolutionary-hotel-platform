...
if ($isLoggedIn && !isset($_SESSION['role'])) {
    try {
        ...
        $stmt = $pdo->prepare("SELECT role, name FROM ainitravel_users WHERE id = ?");
                    ...
                    <div class="relative">
                        ...
                        <div id="profileDropdown" class="profile-dropdown">
                            ...
                            <?php if ($userRole === 'admin'): ?>
                                <a href="admin_experience_moderate.php" style="background: #fef3c7; color: #92400e;">
...
<div id="mobileMenu" class="mobile-menu">
    ...
    <?php if ($isLoggedIn): ?>
        <div class="border-t border-white/30 my-2 pt-2">
            ...
            <?php if ($userRole === 'admin'): ?>
                <a href="admin_experience_moderate.php" style="background: rgba(254, 243, 199, 0.2);">
                    ⚙️ Admin Panel
                </a>
            <?php endif; ?>
