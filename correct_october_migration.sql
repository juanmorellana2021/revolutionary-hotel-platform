-- CORRECT October 2025 Data Migration based on actual XAMPP calendar
-- This matches the exact data shown in the calendar screenshot
...
-- Add the correct users (based on actual October bookings)
...
(37, 'Ruzena', 'Duchkova', 'ruzena.duchkova@gmail.com', '$2y$10$aivpDyB/lmgkt8GhUKgOcOV1IvxVsXgeOoMK.UcqlTvsK8mQzCzQ6', 'guest', 'guest', '2025-10-03 14:37:37', '2025-10-03 14:37:37'),
(38, 'Julia', '', 'overig2019@protonmail.com', '$2y$10$aivpDyB/lmgkt8GhUKgOcOV1IvxVsXgeOoMK.UcqlTvsK8mQzCzQ6', 'guest', 'guest', '2025-10-03 14:37:37', '2025-10-03 14:37:37'),
(39, 'name', '', 'n2@n2.com', '$2y$10$aivpDyB/lmgkt8GhUKgOcOV1IvxVsXgeOoMK.UcqlTvsK8mQzCzQ6', 'guest', 'guest', '2025-10-03 14:37:37', '2025-10-03 14:37:37');

-- Update rooms to match XAMPP system (rooms 101-111)
UPDATE rooms SET room_number = '101' WHERE id = 1;
UPDATE rooms SET room_number = '102' WHERE id = 2;
UPDATE rooms SET room_number = '103' WHERE id = 3;
UPDATE rooms SET room_number = '104' WHERE id = 4;
UPDATE rooms SET room_number = '105' WHERE id = 5;
INSERT IGNORE INTO rooms (id, room_number, room_type, capacity, price_per_night, description) VALUES
(6, '106', 'Twin Beds', 2, 25.00, 'Twin bed room'),
(7, '107', 'Twin Beds', 2, 25.00, 'Twin bed room'),
(8, '108', 'Standard Double', 2, 35.00, 'Standard double room'),
(9, '109', 'Standard Double', 2, 35.00, 'Standard double room'),
(10, '110', 'Standard Double', 3, 40.00, 'Large double room'),
(11, '111', 'Deluxe Queen', 2, 45.00, 'Deluxe queen room');

-- Now add the ACTUAL October 2025 bookings from XAMPP (matching the calendar screenshot)
...
-- Room 101 bookings
(19, 16, 1, '2025-10-01', '2025-10-02', 35.00, 'confirmed', '2025-10-01 09:56:18', 0, NULL),
(22, 18, 1, '2025-10-02', '2025-10-05', 96.00, 'confirmed', '2025-10-02 15:22:03', 0, NULL),
(41, 29, 1, '2025-10-07', '2025-10-09', 179.98, 'confirmed', '2025-10-08 14:50:26', 0, NULL),
(52, 36, 1, '2025-10-10', '2025-10-13', 260.00, 'confirmed', '2025-10-10 14:30:55', 0, NULL),

-- Room 102 bookings  
(9, 9, 2, '2025-09-29', '2025-10-02', 63.57, 'confirmed', '2025-09-29 12:42:13', 0, NULL),
(27, 21, 2, '2025-10-03', '2025-10-05', 129.99, 'confirmed', '2025-10-04 10:53:09', 0, NULL),
(36, 28, 2, '2025-10-07', '2025-10-09', 129.99, 'confirmed', '2025-10-08 14:46:53', 0, NULL),
(55, 38, 2, '2025-10-11', '2025-10-12', 129.99, 'confirmed', '2025-10-11 12:02:54', 0, NULL),

-- Room 103 bookings
(15, 13, 3, '2025-09-30', '2025-10-04', 117.33, 'confirmed', '2025-09-30 14:04:53', 0, NULL),
(14, 13, 3, '2025-09-30', '2025-10-05', 157.33, 'confirmed', '2025-09-30 13:55:30', 0, NULL),
(37, 28, 3, '2025-10-07', '2025-10-10', 180.00, 'confirmed', '2025-10-08 14:47:37', 0, NULL),
(50, 3, 3, '2025-10-10', '2025-10-12', 120.00, 'confirmed', '2025-10-10 13:22:16', 0, NULL),
(51, 35, 3, '2025-10-19', '2025-11-01', 780.00, 'confirmed', '2025-10-10 13:27:07', 0, NULL),

-- Room 104 bookings
(8, 8, 4, '2025-09-30', '2025-10-03', 77.27, 'confirmed', '2025-09-29 09:05:54', 0, NULL),
(28, 20, 4, '2025-10-03', '2025-10-05', 120.00, 'confirmed', '2025-10-04 11:34:13', 0, NULL),
(38, 28, 4, '2025-10-07', '2025-10-09', 120.00, 'confirmed', '2025-10-08 14:48:07', 0, NULL),
(45, 32, 4, '2025-10-09', '2025-10-10', 60.00, 'confirmed', '2025-10-09 08:55:43', 0, NULL),

-- Room 105 bookings
(11, 11, 5, '2025-09-29', '2025-10-02', 12.00, 'confirmed', '2025-09-30 10:43:45', 0, NULL),
(24, 19, 5, '2025-10-03', '2025-10-05', 42.67, 'confirmed', '2025-10-03 15:20:54', 0, NULL),
(23, 19, 5, '2025-10-03', '2025-10-05', 42.67, 'confirmed', '2025-10-03 14:21:49', 0, NULL),
(42, 3, 5, '2025-10-06', '2025-10-10', 240.00, 'confirmed', '2025-10-08 14:55:07', 0, NULL),
(53, 37, 5, '2025-10-10', '2025-10-12', 120.00, 'confirmed', '2025-10-10 14:58:22', 0, NULL),

-- Room 106 bookings
(13, 12, 6, '2025-09-30', '2025-10-02', 52.00, 'confirmed', '2025-09-30 12:58:25', 0, NULL),
(12, 12, 6, '2025-09-30', '2025-10-05', 115.33, 'confirmed', '2025-09-30 12:57:00', 0, NULL),
(32, 24, 6, '2025-10-05', '2025-10-06', 25.00, 'confirmed', '2025-10-05 15:04:18', 0, NULL),
(35, 27, 6, '2025-10-08', '2025-10-12', 100.00, 'confirmed', '2025-10-08 14:30:59', 0, NULL),

-- Room 107 bookings
(10, 10, 7, '2025-09-30', '2025-10-02', 68.57, 'confirmed', '2025-09-29 15:04:00', 0, NULL),
(29, 22, 7, '2025-10-03', '2025-10-05', 69.00, 'confirmed', '2025-10-04 11:54:58', 0, NULL),
(33, 25, 7, '2025-10-05', '2025-10-06', 25.00, 'confirmed', '2025-10-05 15:07:53', 0, NULL),
(43, 30, 7, '2025-10-06', '2025-10-09', 75.00, 'confirmed', '2025-10-08 15:09:15', 0, NULL),
(46, 32, 7, '2025-10-09', '2025-10-10', 25.00, 'confirmed', '2025-10-09 08:56:30', 0, NULL),
(59, 39, 7, '2025-10-11', '2025-10-12', 25.00, 'confirmed', '2025-10-11 21:55:26', 0, NULL),

-- Room 108 bookings
(17, 14, 8, '2025-09-30', '2025-10-02', 40.00, 'confirmed', '2025-09-30 14:31:31', 0, NULL),
(16, 14, 8, '2025-09-30', '2025-10-02', 40.00, 'confirmed', '2025-09-30 14:30:47', 0, NULL),
(30, 22, 8, '2025-10-03', '2025-10-05', 70.00, 'confirmed', '2025-10-04 11:58:10', 0, NULL),
(39, 28, 8, '2025-10-07', '2025-10-09', 70.00, 'confirmed', '2025-10-08 14:48:59', 0, NULL),
(48, 33, 8, '2025-10-09', '2025-10-10', 35.00, 'confirmed', '2025-10-09 13:56:00', 0, NULL),

-- Room 109 bookings
(7, 3, 9, '2025-09-29', '2025-10-05', 112.00, 'confirmed', '2025-09-29 01:43:12', 0, NULL),
(44, 31, 9, '2025-10-07', '2025-10-10', 105.00, 'confirmed', '2025-10-08 16:29:21', 0, NULL),
(57, 38, 9, '2025-10-11', '2025-10-12', 35.00, 'confirmed', '2025-10-11 12:02:54', 0, NULL),

-- Room 110 bookings
(18, 15, 10, '2025-09-30', '2025-10-02', 48.00, 'confirmed', '2025-09-30 14:40:24', 0, NULL),
(31, 23, 10, '2025-10-04', '2025-10-06', 80.00, 'confirmed', '2025-10-04 15:00:42', 0, NULL),
(40, 28, 10, '2025-10-07', '2025-10-09', 80.00, 'confirmed', '2025-10-08 14:49:29', 0, NULL),
(47, 32, 10, '2025-10-09', '2025-10-10', 40.00, 'confirmed', '2025-10-09 08:57:48', 0, NULL),

-- Room 111 bookings
(21, 17, 11, '2025-10-02', '2025-10-03', 35.00, 'confirmed', '2025-10-02 14:56:36', 0, NULL),
(20, 17, 11, '2025-10-02', '2025-10-06', 140.00, 'confirmed', '2025-10-02 14:56:22', 0, NULL),
(34, 26, 11, '2025-10-07', '2025-10-09', 90.00, 'confirmed', '2025-10-07 16:55:41', 0, NULL),
(49, 34, 11, '2025-10-09', '2025-10-12', 135.00, 'confirmed', '2025-10-09 15:31:01', 0, NULL);