...
$headTemplate = new HeadTemplate('Settings', $hotel['hotel_name'] ?? 'AiNi Travel PMS');
$sidebarTemplate = new SidebarTemplate($hotel['hotel_name'] ?? 'AiNi Travel PMS', 'settings', $user['role'] ?? 'manager');
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="content-offset ml-64 transition-all duration-300">
        ...
        <main class="topbar-offset pt-16 p-8">
