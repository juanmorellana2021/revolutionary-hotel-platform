        ...
        <div class="welcome-card">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p style="color: #667eea; margin-top: 0.5rem; font-weight: 600;">
                        <i class="fas fa-building"></i> Current Hotel ID: <?php echo $_SESSION['current_hotel_id'] ?? 'NOT SET'; ?> | 
                        Hotel: <?php echo htmlspecialchars($hotel['hotel_name'] ?? 'Unknown'); ?>
                    </p>
                </div>
                <div class="text-end">
